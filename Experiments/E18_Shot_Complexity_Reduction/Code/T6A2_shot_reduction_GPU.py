...
def run_experiment(
    ...
    # Output directories (relative to Code/)
    script_dir = Path(__file__).parent
    fig_dir = script_dir.parent / "Figures"
    data_path = script_dir.parent / "Data" / "T6A2_results.json"
...
def run_sweep(args):
    ...
    # Save sweep summary (relative to Code/)
    script_dir = Path(__file__).parent
    sweep_path = script_dir.parent / "Data" / f"T6A2_sweep_{param}.json"
