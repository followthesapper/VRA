...
Outputs:
  Figures/Experiments/Tier1/E1D_*.png
  Data/Experiments/Tier1/E1D/E1D_verdict.json
"""
...
def main():
    res_file = Path("../../Data/Experiments/Tier1/E1D/E1D_results.json")
    out_dir = Path("../../Figures/Experiments/Tier1")
