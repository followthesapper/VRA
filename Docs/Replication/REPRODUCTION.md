...
diff Data/Experiments/Validation/Phase1/Baseline_Benchmarks/20251029_231540_benchmark_results.json \
...
**Solution**: Ensure PYTHONPATH includes Code/VRA and Code/Experiments/Statistics:

```bash
export PYTHONPATH=/path/to/VRA/Code/VRA:/path/to/VRA/Code/Experiments/Statistics:$PYTHONPATH
```
